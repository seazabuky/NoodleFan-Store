        ...
        <div class="flex flex-col justify-center px-6 my-12">
                ...
                <div class="w-full bg-white p-5 rounded-lg lg:rounded-l-none">
                    ...
                    <form class="px-8 pt-6 pb-8 mb-4 bg-white rounded" action="upload_db.php" method="POST" enctype="multipart/form-data">
                        <div class="mb-4">
                            ...
                            <input class="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border border-red-500 rounded shadow appearance-none focus:outline-none focus:shadow-outline" id="image" type="file" name="file" accept="image/gif,image/jpg,image/jpeg,image/png">
            ...
            <div class="flex flex-col">
                    <?php if(!empty($_SESSION["statusMsg"])){?>
                        <div class="mb-10 px-5 py-5 bg-gray-300 rounded-lg text-xl italic text-black shadow font-bold " role="alert">
                            <?php 
