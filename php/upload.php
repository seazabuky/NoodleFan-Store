                ...
                <div class="w-full bg-gray-50 p-5 shadow-xl ring-1 ring-gray-900/5 rounded-lg lg:rounded-l-none">
                    ...
                    <form class="px-10 pt-6 pb-8 mb-4 bg-gray-50 rounded" action="upload_db.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-6 pt-2 text-center">
                            <input type="submit" class="w-52 text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2" name="submit" value="Upload"/>
                        </div>
                    </form>
                </div>
            </div>
